class TextManager2D {
  constructor() {
    ...
    this.projectileCooldown = document.getElementById('projectile-cooldown');
  }
  ...
  restoreLives() {
    for (let i = 0; i < 3; i++) this.hp_bars[i].style.visibility = 'visible';
  }
  ...
  updateCooldown(cooldown) {
    this.projectileCooldown.innerText = cooldown;
  }
}
